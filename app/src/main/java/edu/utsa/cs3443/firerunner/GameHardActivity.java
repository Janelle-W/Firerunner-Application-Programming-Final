/**
 * GameHardActivity is a class that represents the gameplay for the hard level in Fire Runner
 *
...
public class GameHardActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void checkGameOver() {
        if (fireCounter >= 15 && isGameActive) {
            ...
            Intent lossintent = new Intent (GameHardActivity.this, LossActivity.class);
        ...
        if (fireCounter == 0 && isGameActive) {
            isGameActive = false; // Set game as inactive to prevent further user interaction
            Intent winIntent = new Intent(GameHardActivity.this, WinActivity.class);
    ...
    private void navigateToMainMenuActivity() {
        Intent mainIntent = new Intent (GameHardActivity.this, MainMenuActivity.class);
