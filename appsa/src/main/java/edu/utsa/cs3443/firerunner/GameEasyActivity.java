...
public class GameEasyActivity extends AppCompatActivity implements View.OnClickListener {
        ...
        handler.postDelayed(new Runnable() {
            ...
            public void run() {
                if (!isGameOver) {
                    ...
                    treeButtonIndexes.remove(randomIndex);
                    ...
                    handler.postDelayed(new Runnable() {
                        ...
                        public void run() {
                            if (!isGameOver) {
                                fireImageView.setImageResource(R.drawable.tree2);
                                startGame();
                            }
                        }
    ...
    public void onClick(View view) {
        if (view.getId() == R.id.button_water) {
            ...
            if (clickedButton.getDrawable().getConstantState().equals(
                    getResources().getDrawable(R.drawable.fire5).getConstantState())) {
